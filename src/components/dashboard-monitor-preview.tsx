  ...
  return (
    <div className={className} aria-hidden>
      ...
      <div className="mx-auto w-full max-w-xl">
        <div className="rounded-[1.1rem] border border-[#2a221c] bg-[#1a1512] p-[0.55rem] shadow-[0_24px_60px_-12px_rgba(26,18,12,0.45)]">
          <div className="overflow-hidden rounded-[0.65rem] border border-[#3d322a] bg-[#f7f5f2]">
            {/* Dashboard chrome */}
            <div className="border-b border-[#e5e0d8] bg-white px-3 py-2.5">
              <p className="text-[7px] uppercase tracking-[0.18em] text-[#8a8178]">Admin</p>
              <p className="text-[11px] font-medium text-[#1a1512]">Restadigi Dashboard</p>
            </div>

            <div className="flex min-h-[14rem] sm:min-h-[16.5rem]">
              {/* Sidebar */}
              <nav className="hidden w-[5.25rem] shrink-0 border-r border-[#e5e0d8] bg-[#faf8f5] p-2 sm:block">
                {[
