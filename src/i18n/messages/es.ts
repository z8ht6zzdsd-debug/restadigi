...
export const es: Messages = {
  ...
  booking: {
    ...
    demo: {
      ...
      infoBody: "Empieza eligiendo una opción — la configuración viene del panel de admin.",
      ...
      type: "Tipo",
      when: "Día y hora",
      normalType: "Reserva normal",
      name: "Nombre",
      phone: "Móvil",
      email: "E-mail",
      comment: "Comentar",
      termsFallback: "Acepto las condiciones. Esto es una demo: no se guardan datos.",
      submit: "Enviar reserva",
      sending: "Enviando…",
      successTitle: "¡Gracias — demo lista!",
      successBody:
        "En una instalación real el cliente recibiría confirmación por email y la reserva aparecería en el panel. En esta demo no se ha guardado nada.",
