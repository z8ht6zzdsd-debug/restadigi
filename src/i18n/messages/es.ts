...
export const es: Messages = {
  ...
  booking: {
    ...
    demo: {
      ...
      sectionBody:
        "Aquí tienes la experiencia de reservas de mesa de Restadigi. En el panel de administración puedes editar el nombre, los horarios y los textos en finlandés, inglés y español. Los datos de esta demo no se guardan.",
      bannerEyebrow: "Restadigi — demo del producto",
      bannerBody:
        "Este flujo muestra el servicio de reservas de mesa de Restadigi. Lo que rellenes es solo un ejemplo: no se almacena. En una instalación real, las reservas aparecerían en el panel de administración.",
      liveBadge: "Demo",
