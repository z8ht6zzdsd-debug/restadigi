...
export const fi: Messages = {
  ...
  home: {
    ...
    testimonial: {
      quote:
        "Restadigi teki meille mobiilisovelluksen, jolla asiakkaat voivat tilata juomat valmiiksi noutoon, maksaa suoraan apissa ja kerryttää etuja kanta-asiakasohjelmassa — palvelu nopeutui ja asiakaskokemus parani huomattavasti.",
