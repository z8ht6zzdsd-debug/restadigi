...
export const en: Messages = {
  ...
  booking: {
    ...
    demo: {
      ...
      sectionBody:
        "This is Restadigi’s table-booking experience. In the admin dashboard you can edit the name, times and copy in Finnish, English and Spanish. Demo data is not saved.",
