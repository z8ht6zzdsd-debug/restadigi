        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 lg:grid-rows-2 gap-4 sm:gap-5">
            ...
            <article className="relative isolate overflow-hidden rounded-[1.75rem] sm:rounded-[2rem] lg:col-start-2 lg:row-start-1 lg:row-span-2 flex flex-col bg-white text-foreground order-first lg:order-none">
              ...
              <div className="mt-auto shrink-0 bg-white px-5 pt-4 pb-5 sm:px-7 sm:pt-5 sm:pb-6">
                <DashboardStripPreview className="mb-3 sm:mb-4" />
                <div className="flex min-h-[3.5rem] items-center justify-between gap-4 sm:min-h-[4rem]">
                  <div className="min-w-0">
          ...
          <h2 className="mt-14 sm:mt-16 mb-8 whitespace-nowrap text-[1.85rem] font-extrabold leading-[0.98] tracking-tight sm:mb-10 sm:text-4xl lg:text-[2.75rem]">
