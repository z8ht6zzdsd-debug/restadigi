...
export const Route = createFileRoute("/restachat")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Restachat — Restadigi" },
      {
        property: "og:description",
        content: "Restachat — ympärivuorokautinen myynti ja asiakaspalvelu chatissa.",
      },
    ],
  }),
  component: RestachatPage,
});
    ...
    <div className="min-h-screen bg-background text-foreground font-sans antialiased">
      ...
      <MarketingBand>
        ...
        <MarketingBox
          tone="white"
          justify="start"
          className="mb-4 min-h-[10rem] sm:mb-5 sm:min-h-[11rem]"
        >
