    ...
    <div className="min-h-screen bg-background text-foreground font-sans antialiased">
      ...
      <header className="pt-10 pb-16 sm:pt-16 sm:pb-24">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-xs uppercase tracking-[0.2em] text-accent mb-8">Pöytävarauspalvelu</div>
          <h1 className="text-4xl sm:text-6xl lg:text-7xl leading-[1.02] font-medium text-balance max-w-[22ch] mb-8 tracking-tight">
            Sujuvat <span className="font-serif italic text-accent">pöytävaraukset</span> suoraan sivustolta.
          </h1>
          <p className="max-w-2xl text-base sm:text-lg text-foreground/70 leading-relaxed">
            Integroimme ravintolasi verkkosivuille modernin pöytävarauspalvelun, joka toimii ympäri vuorokauden.
            Asiakas valitsee ajan ja seurueen koon, saa vahvistuksen sähköpostiin ja henkilökuntasi näkee varaukset
            selkeästä hallintapaneelista.
          </p>
        </div>
      </header>
      ...
      <section className="pb-24 sm:pb-32">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-10">(01) Keskeiset hyödyt</div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { title: "Varaukset 24/7", body: "Asiakkaat voivat varata pöydän silloin kun heille sopii — ilman puhelinsoittoja." },
              { title: "Vähemmän no-showta", body: "Automaattiset vahvistukset ja muistutukset vähentävät saapumatta jäämisiä." },
              { title: "Selkeä hallinta", body: "Näet päivän varaukset yhdellä silmäyksellä ja voit muokata saatavuutta helposti." },
              { title: "Integroitu sivustoon", body: "Palvelu istuu saumattomasti ravintolasi verkkosivujen ilmeeseen." },
            ].map((b) => (
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-12 gap-12 items-end">
            <div className="md:col-span-8">
              <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-6">(02) Aloitetaan</div>
